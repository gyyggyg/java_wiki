...
用法：
    ...
    python business_flow/regenerate_section5.py --flow "稿件资讯流"
    python business_flow/regenerate_section5.py --flow "稿件资讯"  # 去"流"也行，脚本自动补

    # 指定输入/输出路径
    python business_flow/regenerate_section5.py \
        --meta business_flow/output/稿件资讯.meta.json \
        --out  /tmp/new.meta.json

    # 创建 .bak 备份再覆盖
    python business_flow/regenerate_section5.py --flow "稿件资讯流" --backup
"""
...
from business_flow.sections import build_control_flow_section
